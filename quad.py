...
x1 = (-b+d**(1/2)) / (2*a) # TODO: write a code to compute the first root of the quadratic equation
x2 = (-b-d**(1/2)) / (2*a) # TODO: then do the same for the second root
...
#       ex) The values of x=10 and y=3 should print out the following:
#            3
#            1
